...
1. Upload `cifar-100-python.tar.gz`  (official CIFAR-100 archive) **wget https://www.cs.toronto.edu/~kriz/cifar-100-python.tar.gz**[wget https://www.cs.toronto.edu/~kriz/cifar-100-python.tar.gz
](url)
